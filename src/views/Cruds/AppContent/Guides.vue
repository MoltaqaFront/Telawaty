    ...
    <div class="single_step_form_content_wrapper">
      <form @submit.prevent="validateFormInputs">
        <div class="row">
          ...
          <base-input col="4" type="text" :placeholder="$t('PLACEHOLDERS.titleAr')" v-model.trim="data.nameAr" required />

          <base-input col="4" type="text" :placeholder="$t('PLACEHOLDERS.titleEn')" v-model.trim="data.nameEn" required />
          ...
          <base-text-editor col="4" :placeholder="$t('PLACEHOLDERS.contentAr')" v-model.trim="data.contentAr" required />
          <!-- End:: Ar Content Text Editor -->

          <!-- Start:: En Content Text Editor -->
          <base-text-editor col="4" :placeholder="$t('PLACEHOLDERS.contentEn')" v-model.trim="data.contentEn" required />
...
export default {
  ...
  methods: {
    ...
    async submitForm() {
      ...
      REQUEST_DATA.append("key", "instructions");
