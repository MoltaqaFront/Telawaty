  ...
  methods: {
    ...
    async submitForm() {
      ...
      try {
        ...
        localStorage.setItem("Telawaty_admin_dashboard_verification_code", res.data.data.code);
        localStorage.setItem("Telawaty_admin_dashboard_forget_pass_token", res.data.data.access_token);
